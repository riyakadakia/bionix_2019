...
void autonomous(void) {
  ...
  moveRobot(20,50,1);
  //RightFrontBaseMotor.rotateFor(-1500,vex::rotationUnits::raw,false);
  //LeftFrontBaseMotor.rotateFor(1500,vex::rotationUnits::raw,true);

  LeftClawMotor.spinFor(reverse, 90 ,degrees);

  wait(1, timeUnits::sec);

  startSpinningClaws(100, 1);
  wait(3, sec);
  stopSpinningClaws();
  moveRobot(20,50,-1);
